...
$config['LicenseName'] = 'New Target';
$config['LicenseKey'] = '8JYL-54YK-UK57-9QL5-U9KN-FJ2Z-UNRN';
...
'directory' => $baseDir,
'maxSize' => 0,
    'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,wpd,xls,xlsx,zip,exe,mdb,cab,lst',
'deniedExtensions' => '');
...
'name' => 'Private',
'url' => '/system/files',
		'directory' => '/var/www/reit/sites/default/private',
'maxSize' => 0,
    'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,wpd,xls,xlsx,zip,exe,mdb,cab,lst',
'deniedExtensions' => '');
